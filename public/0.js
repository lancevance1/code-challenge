  ...
  return _c("main", [
    _c(
      ...
      [
        ...
        _vm._v(" "),
        _c("inertia-link", { attrs: { href: "/media" } }, [_vm._v("Media")]),
        _vm._v(" "),
        _c("inertia-link", { attrs: { href: "/search" } }, [_vm._v("Search")])
      ],
      1
    ),
    _vm._v(" "),
...
var render = function() {
  ...
  return _c("layout", { attrs: { title: "Welcome" } }, [
    ...
    _c("p", [
      _vm._v(
        "Hello " +
          _vm._s(_vm.$page.props.user) +
          ", welcome " +
          _vm._s(_vm.$page.props.media) +
          " to your first Inertia app!"
      )
    ])
  ])
}
